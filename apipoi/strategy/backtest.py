        ...
        try:
            if indi:
                index, long_entry,\
                       ...
                       gross_income,\
                       fee, \
                       gross_fee = auto_paper_trade_macd_tradition_individual(symbol_pair, time_step,
            ...
            if i < 9:
                plt.savefig('{}_backtest_{}_i={}_ftp={}_fcl={}_tp{}_cl{}_in_0{}_{}.png'.format(symbol_pair, time_step,
                                                                                               indi,
                                                                                               fix_tp, fix_cl,
                                                                                               tp*100, cl*100,
                                                                                               i+1, date_start), dpi=400)
            else:
                plt.savefig('{}_backtest_{}_i={}_ftp={}_fcl={}_tp{}_cl{}_in_{}_{}.png'.format(symbol_pair, time_step,
                                                                                              indi,
                                                                                              fix_tp, fix_cl,
                                                                                              tp*100, cl*100,
                                                                                              i+1, date_start), dpi=400)
