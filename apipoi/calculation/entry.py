...
def tp_cl(entry_price, tp_pc, cl_pc):

    take_profit_percent = tp_pc      # tp
    cut_loss_percent = cl_pc         # sl

#   Long position
    take_profit_long = 1 + take_profit_percent
    cut_loss_long = 1 - cut_loss_percent
#   Calculate tp/sl
    tp_price = entry_price * take_profit_long
    cl_price = entry_price * cut_loss_long

    return tp_price, cl_price
